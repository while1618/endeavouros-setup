...
cp -rf ./config/alacritty ./config/dunst ./config/gtk-3.0 ./config/gtk-4.0 ./config/hypr ./config/picom ./config/scripts .config/Thunar ./config/wal ./config/waybar ./config/wlogout ~/.config
